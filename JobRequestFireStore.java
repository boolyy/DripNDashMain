...
public class JobRequestFireStore extends JobRequest{
    ...
    public JobRequestFireStore(String jobID, String customerUID, Timestamp requestTimestamp, String customerName, String dorm, String dormRoom, String customerInstructions, int numLoadsEstimate, String dasherUID, String dasherName, String dasherRating, Timestamp assignedTimestamp, int currentStage, int numLoadsActual) {
    ...
    // Get the oldest Job in the database (NEEDS WORK)
    private void getOldestJob(){

        // Order the database
        db.collection("jobsInProgress")
                .orderBy("REQUEST_TIMESTAMP", Query.Direction.ASCENDING);
